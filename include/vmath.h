...
struct random<float>
{
    operator float()
    {
        ...
        tmp = seed ^ (seed >> 4U) ^ (seed << 15U);
        tmp = (tmp >> 9U) | 0x3F800000UL;
...
public:
    ...
    inline Tvec2() {}
    // Copy constructor
    inline explicit Tvec2(const base& v) : base(v) {}
...
public:
    ...
    // Copy constructor
    inline explicit Tvec3(const base& v) : base(v) {}
...
public:
    ...
    // Copy constructor
    inline explicit Tvec4(const base& v) : base(v) {}
...
public:
    ...
    inline explicit Tquaternion(T _r)
        : r(_r),
          v(T(0))
    {
    ...
    inline explicit Tquaternion(const Tvec4<T>& _v)
        : r(_v[0]),
          v(_v[1], _v[2], _v[3])
    {
    }
...
public:
    ...
    inline explicit matNM(const vector_type& v)
    {
        for (int n = 0; n < w; n++)
        {
            data[n] = v;
...
public:
    ...
    inline explicit Tmat4(const base& that) : base(that) {}
    inline explicit Tmat4(const vecN<T,4>& v) : base(v) {}
...
public:
    ...
    inline explicit Tmat2(const base& that) : base(that) {}
    inline explicit Tmat2(const vecN<T,2>& v) : base(v) {}
